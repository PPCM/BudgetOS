...
export class CreditCard {
  ...
  static create(userId, data) {
    ...
    query.run(`
      INSERT INTO credit_cards (
        ...
        debit_type, cycle_start_day, debit_day, debit_days_before_end,
    ...
    `, [
      ...
      data.cardNumberLast4 || null, data.debitType, data.cycleStartDay || 1,
  ...
  static update(id, userId, data) {
    ...
    const allowedFields = [
      'linked_account_id', 'name', 'card_number_last4', 'debit_type',
